...
#if defined(_WIN32)
#define SPH2PIPE_EXPORT __declspec(dllexport)
#elif defined(__GNUC__)
#define SPH2PIPE_EXPORT __attribute__((visibility("default"))) __attribute__((used))
#else
#define SPH2PIPE_EXPORT
#endif
...
SPH2PIPE_EXPORT int sph2pipe_shorten_to_pcm16le(
    const char *sph_path,
    long header_bytes,
    const char *pcm_path) {
